...
public class Question1 extends Application {
    ...
    private String StrLength,StrWidth;
    ...
    public void start(Stage primaryStage) {
        ...
        enterBTN.setOnAction(e->{
            ...
            try{
            StrLength = length.getText();
            double DouLength = Double.parseDouble(StrLength);

            StrWidth = width.getText();
            double DouWidth = Double.parseDouble(StrWidth);
            
            X.setLength(DouLength);
            X.setWidth(DouWidth);
            
            OutArea.setText(String.valueOf(X.getArea()));
            OutPerimeter.setText(String.valueOf(X.getPerimeter()));
